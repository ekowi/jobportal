                        ...
                        <table class="table table-center bg-white mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom p-3">Tanggal Lamar</th>
                                    <th class="border-bottom p-3">Detail</th>
                                    <th class="border-bottom p-3">Alur Rekrutmen</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($lamaranList as $index => $lamaran)
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3 text-center">
                                            <button class="btn btn-sm btn-soft-primary" title="Detail kandidat" wire:click="viewDetail({{ $lamaran->id }})">
                                            ...
                                            <div class="recruitment-flow">
                                                ...
                                                <div class="flow-step {{ $interviewProgress ? 'completed' : ($currentStatus == 'pending' ? 'active' : 'disabled') }}">
                                                    ...
                                                    @elseif($isRecruiter && $currentStatus == 'pending')
                                                        <div class="text-muted small interview-details">
            ...
            <div class="modal-content">
                <form wire:submit.prevent="saveInterview">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" wire:click="$set('interviewModal', false)">Batal</button>
                    ...
                    @if($selectedKandidat)
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0 fw-semibold">{{ $selectedKandidat->nama_depan }} {{ $selectedKandidat->nama_belakang }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Email</label>
                                <p class="mb-0 fw-semibold">{{ optional($selectedKandidat->user)->email }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0 fw-semibold">{{ $selectedKandidat->no_npwp ?? '-' }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tempat & Tanggal Lahir</label>
                                <p class="mb-0 fw-semibold">{{ $selectedKandidat->tempat_lahir }}, {{ optional($selectedKandidat->tanggal_lahir)->format('d M Y') }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Jenis Kelamin</label>
                                <p class="mb-0 fw-semibold">{{ $selectedKandidat->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0 fw-semibold">{{ $selectedKandidat->no_telpon_alternatif ?? '-' }}</p>
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label">Alamat</label>
                                <p class="mb-0 fw-semibold">{{ $selectedKandidat->formatted_address }}</p>
                            </div>
                        </div>
                            ...
                            @foreach($docLabels as $key => $label)
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if(isset($documents[$key]))
                                        <div>
                                            <a href="{{ Storage::url($documents[$key]) }}" target="_blank" class="text-primary">
